...
export default function Page() {
  return (
    <div className="space-y-6 max-w-3xl">
      <h1 className="text-xl font-black text-white capitalize">GPS Rutas</h1>
      <div className="rounded-2xl bg-slate-900 border border-slate-800 p-8 text-center space-y-3">
        <p className="text-slate-400 text-sm">
          Módulo GPS en construcción. Usa el preview de la landing como base (
          <code className="text-emerald-400">GpsPreview</code>).
        </p>
